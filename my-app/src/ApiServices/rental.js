...
async function AddpropertyRents(rentalBreakdown) {
    try {
...
async function MonthlyInterest(interest){
    try {
...
async function MonthlyCapital(CapitalRepayment){
    try {
...
async function GetMonthlyRents(id){
    try {
...
async function GetMonthlyCapitalRepayments(id){
    try {
        const response = await fetch(`${URL}/summary/${id}/GetMonthlyCapitalRepayments`);
        return await response.json();
    } catch (error) {
        console.error(error);
    }
...
async function GetMonthlyInterestExpense(id){
    try {
        const response = await fetch(`${URL}/summary/${id}/GetMonthlyInterestExpense`);
        return await response.json();
    } catch (error) {
        console.error(error);
    }
...
export { AddpropertyRents, MonthlyInterest, MonthlyCapital, GetMonthlyInterestExpense, GetMonthlyCapitalRepayments,GetMonthlyRents };